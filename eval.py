...
parser.add_argument(
    "--step", type=int, default=1000, metavar="step", help="loading step"
)
parser.add_argument(
...
parser.add_argument(
    "--output", type=str, default="./output.txt", help="path to store result file"
)
parser.add_argument(
    "--net", type=str, default="resnet34", metavar="B", help="which network "
)
parser.add_argument("--source", type=str, default="real", metavar="B", help="board dir")
parser.add_argument(
    "--target", type=str, default="sketch", metavar="B", help="board dir"
)
parser.add_argument(
    "--dataset",
    type=str,
...
print(
    "dataset %s source %s target %s network %s"
    ...
    torch.load(
        os.path.join(
            ...
            "to_{}_step_{}.pth.tar".format(
                args.method, args.source, args.target, args.step
            ),
        )
    )
)
